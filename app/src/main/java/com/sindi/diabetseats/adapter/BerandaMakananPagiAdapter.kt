...
class BerandaMakananPagiAdapter(
    dataList: List<HintsItem>,
    ...
    inner class BerandaMakananPagiViewHolder(val binding: ItemMakananBerandaBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemMakananBerandaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return BerandaMakananPagiViewHolder(binding)
    }

    override fun onBindViewHolder(
        holder: BerandaMakananPagiAdapter.BerandaMakananPagiViewHolder,
        position: Int
    ) {
