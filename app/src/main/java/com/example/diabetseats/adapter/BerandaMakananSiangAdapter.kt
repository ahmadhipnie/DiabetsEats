...
class BerandaMakananSiangAdapter(dataList: List<HintsItem>, private val berandaViewModel: BerandaViewModel,
                                 private val coroutineScope: CoroutineScope)
    : RecyclerView.Adapter<BerandaMakananSiangAdapter.BerandaMakananSiangViewHolder>() {
    ...
    inner class BerandaMakananSiangViewHolder(val binding: ItemMakananBerandaBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BerandaMakananSiangAdapter.BerandaMakananSiangViewHolder {
        val binding = ItemMakananBerandaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return BerandaMakananSiangViewHolder(binding)    }

    override fun onBindViewHolder(holder: BerandaMakananSiangAdapter.BerandaMakananSiangViewHolder, position: Int) {
